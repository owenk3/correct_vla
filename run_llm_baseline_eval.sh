...
CMD="python experiments/robot/libero/vla_eval_failures.py --pretrained_checkpoint lerobot/pi05_libero_finetuned --model_family pi05 --eval llm_baseline --use_model_server True --num_recovery_trials 1 --num_trials_per_task 50"
